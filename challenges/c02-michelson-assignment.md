...
are decently distinct (2 or 3). - Images with higher distinctness have
higher average velocity. - Why might your table differ from
Michelson’s? - It looks like he might have rounded his values.
...
uncertainty) greater or less than the true error? - His uncertainty is
less than the true error. - Make a quantitative comparison between
Michelson’s uncertainty and his error. - His uncertainty was 51, while
his error was 151.542.
...
**Observations**: Similarities - The two plots follow the same shapes,
with peaks/valleys happening on the same days in the same order. - The
spreads of the measurements for each day also seem about the same, i.e.,
the individual measurements for one are not more or less spread out than
the other. Differences - The simulated data is more consistent and
within the expected values at the beginning, but peaks above the
expected values near the end of the measurement period, while the actual
values follow the opposite pattern.
...
- It looks like the temperature didn’t affect the measured velocity that
  much.
- However, this graph also shows correlation between distinctness and
  velocity, which I noticed before too.
- It also looks like it might be harder to get a distinct image in lower
  temps.
...
This shows that there are indeed more distinct images in higher
temperatures
