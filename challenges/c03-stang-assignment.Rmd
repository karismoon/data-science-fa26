...
- Is there "one true value" for the material properties of Aluminum?
  - No, there's no one true value, each value has some variation within it.
...
- It looks like elasticitiy is not correlated to thickness, based on the fact that the elasticity of .064 and .022 are similar. 
...
- Does this graph support or contradict the claim above?
  - It contradicts the claim, because elasticity does seem to depend on the thickness.
  - The thickness .081 has the lowest elasticity and the colors are generally all
    at the same level.
- Is this evidence *conclusive* one way or another?
  - I don't think so, because although .081 stands out, the other thicknesses are
    seemingly all at the same area on the Y-axis.
