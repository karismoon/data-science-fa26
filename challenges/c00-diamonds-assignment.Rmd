...
It's kind of hard to tell but it looks like all the fair cuts are lower in price within each carat category. However there are some outliers for very high carat so maybe it doesn't matter as much as the carats gets higher.
