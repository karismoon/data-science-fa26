...
**Observations**:
- not correct, the ideal is actually the most numerous cut
...
**Observations**:
I cannot tell anything from this graph
...
**Observations**:
Cut doesn't affect price that much
...
**Observations**:
Higher carat diamonds usually have worse cuts
