...
- there are walls where the price dramatically increases at round numbers like 1, 1.5, and 2
- in between these walls the price is about the same.
...
It's hard to tell but it looks like all the fair cuts are lower in price within each carat category. However there are some outliers for very high carat so maybe it doesn't matter as much as the carats gets higher.
