...
df_q6b <- flights %>% filter(origin == "JFK" | dest == 'LGA' | dest == 'EWR' )
...
flights out of NYC, all the flights are coming out of NYC while only flight is going into NYC
