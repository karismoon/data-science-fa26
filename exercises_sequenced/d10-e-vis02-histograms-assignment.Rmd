...
vis1 helps with the first question because it shows actual values, while vis2 helps with the second because it is easier to see if values for that cty value exists.
...
**Observations**
- larger bins show a U shape, with peaks near the edges
- smaller bins preserve this shape but show there are a lot more peaks within as well, up to 0.04 you can clearly see the walls at the round numbers
