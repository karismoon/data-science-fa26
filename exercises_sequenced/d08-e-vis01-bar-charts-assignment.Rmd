...
**Observations**:
the colors don't add any info lol. it looks nice though
...
**Observations**:
it shows what types of drive trains are within each class
...
each aesthetic of the bar graph represented a different variable
...
**Observations**
it shows that certain manufacturers only make one class of car, while others make many different classes
