...
install.packages() installs the package onto your computer, library() loads it into the file and makes it accessible.
You only need to install once, but you need to load for each file.
