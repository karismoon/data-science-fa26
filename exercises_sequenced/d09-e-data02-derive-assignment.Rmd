...
They produce the same output but one uses the pipe symbol and is therefore more legible.
...
- cov_depth is very small, and cov_diff is very large
- This is because the mean for cov_diff is small
